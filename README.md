...
Convert an online lecture video (.mp4) into a pdf with the transcript per corresponding slide per page. The audio2text conversion is performed by the [tiny.en](https://github.com/openai/whisper) [faster-whisper](https://pypi.org/project/faster-whisper/) model.
